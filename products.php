...
<html lang="en">
    ...
    <body> 
        ...
        <div class="prod-nav">
            <ul>
                <li><a href="products.php?type=UCLan Hoodie">Hoodies |</a></li> <!--These all have a href which links to products.js allowing the navigation-->
                <li><a href="products.php?type=UCLan Logo Jumper"> Jumpers |</a></li>
                <li><a href="products.php?type=UCLan Logo Tshirt"> T-Shirts</a></li>
            </ul>
        </div>
        ...
        <script src="products.js"></script> <!--This links the JavaScript file standard.js to this, allowing the use of the hamburger menu (https://www.w3schools.com/howto/howto_css_menu_icon.asp)-->
    </body>
</html>